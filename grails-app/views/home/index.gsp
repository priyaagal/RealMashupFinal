	...
	<div class="slide story" id="slide-1" data-slide="1">
		<div class="container">
			<div id="home-row-1" class="row clearfix">
				<div class="col-12">
					<h1 class="font-semibold">Real Estate <span class="font-thin">Analytics</span></h1>
					<h4 class="font-thin">We bring you vibes</h4>
					<br>
					<br>
				</div><!-- /col-12 -->
			</div><!-- /row -->
			...
			<h1>Find the Best Places to Live</h1>
				<g:form class="navbar-form navbar-center" role="search" name="search"
					controller="Home" action="listings">
					<div class="form-group">
						<g:textField name="query" class="form-control"
							placeholder="e.g. Sunnyvale, CA" />
					</div>
					<button type="submit" class="btn btn-primary" data-loading-text="Searching...">Go!</button>
				</g:form>
			</div>
			<div id="home-row-3" class="row clearfix">
